...
<article class="flex h-full min-h-0 w-full flex-col overflow-hidden rounded-b-lg">
	<div
		class="h-full min-h-0 w-full min-w-0 overflow-auto text-sm [&_pre]:!m-0 [&_pre]:!min-h-full [&_pre]:!w-full [&_pre]:![min-width:min-content] [&_pre]:!rounded-none [&_pre]:!p-4 [&_pre]:!text-left"
	>
