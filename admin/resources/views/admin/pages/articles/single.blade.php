                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control summernote @error('description') is-invalid @enderror" name="description" data-folder="uploads/admin/temp" data-route="{{url('/')}}">{{ $post->description }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
