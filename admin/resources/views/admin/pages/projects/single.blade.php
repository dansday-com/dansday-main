                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea class="form-control summernote @error('description') is-invalid @enderror" name="description" data-folder="uploads/admin/temp" data-route="{{url('/')}}">{{ $project->description }}</textarea>
                                    @error('description')
